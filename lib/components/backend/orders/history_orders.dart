...
import 'package:tdvp/components/backend/orders/detail_order.dart';
...
class MISOrdersListsPages extends StatefulWidget {
  const MISOrdersListsPages({Key? key}) : super(key: key);

  @override
  _MISOrdersListsPagesState createState() => _MISOrdersListsPagesState();
}

class _MISOrdersListsPagesState extends State<MISOrdersListsPages> {
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            newLabel(
                              title: 'ชื่อผู้สั่ง :',
                              subTitle: userModels[index].name,
                            ),
                            newLabel(
                                title: 'วันสั่งของ :',
                ...
                itemBuilder: (context, index) => Container(
                  ...
                  child: InkWell(
                    ...
                    onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => MISOrdersPages(
