...
class StyleProjects {
  ...
  Color cardStream7 = const Color.fromARGB(255, 182, 45, 21);
  Color cardStream8 = const Color(0xffe71461);
  Color cardStream9 = const Color(0xfff0578f);
  Color cardStream10 = const Color(0xffee407f);
  Color cardStream11 = const Color.fromARGB(255, 255, 23, 23);
  ...
  TextStyle topicstyle9 = const TextStyle(
      fontFamily: 'THSarabunNew',
      color: Color(0xff000000),
      fontWeight: FontWeight.bold,
      fontSize: 20);
